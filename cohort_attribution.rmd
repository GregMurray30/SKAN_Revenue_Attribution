...
fit_chrt_attr_goodprior = sampling(chrt_attr_mod1, list( I_ea_a=I_ea_a, K_skan = K_skan, prior_mu_c_a=prior_mu_c_a_good, num_cmps=num_cmps  ), chains=4, iter=20000, warmup=3000)
